...
- /ytp : To play a song from youtube(THIS MAY CAUSE ERRORS SO IF U SEE ANY ERROR REPORT IT @JARVISUPPORT
- /skip : Skips current song (Admin only)
- /end : End the music play (Admin only)
- /seaech : To search a particular song and returns the youtube link for it.
